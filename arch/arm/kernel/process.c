...
/* LGE_CHANGE: lge crash handler * 2012-07-11, kyeongdon.kim@lge.com  */
...
#else // not CONFIG_LGE_HANDLE_PANIC
...
/* LGE_BSP_COMMON sangcheol.seo@lge.com 131015 : porting */
			#ifdef CONFIG_LGE_HANDLE_PANIC
			 /* LGE_CHANGE: lge crash handler, refer to D1L model  * 2012-07-18, kyeongdon.kim@lge.com  */
			c1=transbase;
			c2=dac;
			#endif
		}
