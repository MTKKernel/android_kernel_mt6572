...
static struct vibrator_hw cust_vibrator_hw = {
    ...
    #if 1  /* LGE_BSP_COMMON LGE_CHANGE_S 131120 jongwoo82.lee : guarantee 50ms(vib_timer) vibrating time for input time 1ms~49ms  */
	.vib_limit = 0,
    #else
	.vib_limit = 9,
    #endif  /* LGE_BSP_COMMON LGE_CHANGE_E 131120 jongwoo82.lee : guarantee 50ms(vib_timer) vibrating time for input time 1ms~49ms */
  #endif
  	.vosel = VOL_3300,
};
