...
/* LGE_BSP_COMMON sangcheol.seo@lge.com 131015 : porting */
/* LGE_CHANGE_S: [2012-08-07] duvallee.lee@lge.com [MT6575] V3/V5 : ram dump for kernel crash */
#include "mach/devs.h"
/* LGE_CHANGE_E: [2012-08-07] duvallee.lee@lge.com */
...
#if defined(TARGET_S4) // ONE_BIN_MEMORY
#if defined(CONFIG_LGE_HANDLE_PANIC) || defined(CONFIG_LGE_HIDDEN_RESET)
    mt_io_desc[6].pfn = __phys_to_pfn(LGE_BSP_RAM_CONSOLE_PHY_ADDR);
#endif
#endif
