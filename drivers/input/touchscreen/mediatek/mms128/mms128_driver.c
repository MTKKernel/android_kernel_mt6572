...
****************************************************************************/
static ssize_t mms128_show_update ( struct kobject *kobj, struct kobj_attribute *attr, char *buf )
{
//   char ver[20];
...
static ssize_t mms128_store_update ( struct kobject *kobj, struct kobj_attribute *attr, const char *buf, size_t count )
{
	int hw_ver;
	sscanf ( buf, "%d", &hw_ver );
...
static ssize_t mms128_store_reset ( struct kobject *kobj, struct kobj_attribute *attr, const char *buffer100, size_t count )
{
	uint8_t buf[TS_READ_REGS_LEN] = { 0, };
	int read_num = 0;
