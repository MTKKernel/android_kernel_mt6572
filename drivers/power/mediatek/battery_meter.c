...
static int battery_meter_suspend(struct platform_device *dev, pm_message_t state)    
{
	...
	getrawmonotonic(&g_rtc_time_before_sleep);
...
//    kal_int32 vbat_diff = 200;
...
#endif        
    {
		...
		getrawmonotonic(&rtc_time_after_sleep);
        
    	if(rtc_time_after_sleep.tv_sec - g_rtc_time_before_sleep.tv_sec > 3600)	//1hr
    	{
