...
#if 0
/*                                                                                                                   */
static bool bIsEnableConsoleUart = FALSE;
/*                                                                                                                   */
#endif
//                                  
//==============================================================================
...
/*                                                                                                                   */
    ...
    if (bIsEnableConsoleUart)
    {
        err = mtk_uart_init_ports();
        if (!err)
        {
...
/*                                                                                                                   */
#if 0
    if (bIsEnableConsoleUart == FALSE)
    {
        mtk_uart_drv.cons = NULL;
        mtk_uart_init_ports();
    }
#endif
/*                                                                                                                   */
