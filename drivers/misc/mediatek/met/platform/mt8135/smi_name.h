...
struct smi_desc larb0_desc[] = {
	{ 0,	"VENC_REF_LUMA",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 1,	"VENC_REF_CHROMA",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 2,	"VENC_REC_FRM",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 3,	"VENC_RCPU",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 4,	"VENC_BSDMA",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 5,	"VENC_CUR_LUMA",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 6,	"VENC_CUR_CHROMA",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 7,	"VENC_RD_COMV",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 8,	"VENC_SV_COMV",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC }
};
...
struct smi_desc larb3_desc[] = {
	...
	{ 2,	"IMGI",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 3,	"VIPI",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 4,	"VIP2I",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 5,	"DISPO",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 6,	"DISPCO",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 7,	"DISPVO",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 8,	"VIDO",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 9,	"VIDCO",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 10,	"VIDVO",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
...
struct smi_desc common_desc[] = {
	...
	{ 8,	"AXI_GCPU",	SMI_DEST_EMI, SMI_RW_RESPECTIVE, SMI_BUS_NONE }
};
