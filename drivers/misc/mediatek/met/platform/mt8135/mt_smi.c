...
void SMI_Init(void)
{
	...
	u4SMICommBaseAddr[0] = SMI_COMMON_EXT_BASE;
}
...
int larb_clock_on(int larb_id)
{
    ...
    {
        case 0:
           //enable_clock( MT_CG_SMI_LARB0_SW_CG, name);
           enable_clock( MT_CG_TOP_PDN_VENC, name);
           break;
        case 1:
           enable_clock(MT_CG_TOP_PDN_VDEC, name);
           enable_clock(MT_CG_VDEC_LARB_CKEN, name);
           break;
        case 2:
           enable_clock(MT_CG_DISP_SMI_LARB2, name);
           break;
        case 3:
           enable_clock(MT_CG_ISP_LARB3_SMI_CKPDN, name);
           break;
        case 4:
           enable_clock(MT_CG_ISP_LARB4_SMI_CKPDN, name);
           break;
        case 5:
           enable_clock(MT_CG_ISP_LARB4_SMI_CKPDN, name);
           break;
...
int larb_clock_off(int larb_id)
{
    ...
    {
        case 0:
           //disable_clock( MT_CG_SMI_LARB0_SW_CG, name);
           disable_clock( MT_CG_TOP_PDN_VENC, name);
           break;
        case 1:
           disable_clock(MT_CG_TOP_PDN_VDEC, name);
           disable_clock(MT_CG_VDEC_LARB_CKEN, name);
           break;
        case 2:
           disable_clock(MT_CG_DISP_SMI_LARB2, name);
           break;
        case 3:
           disable_clock(MT_CG_ISP_LARB3_SMI_CKPDN, name);
           break;
        case 4:
           disable_clock(MT_CG_ISP_LARB4_SMI_CKPDN, name);
           break;
        case 5:
           disable_clock(MT_CG_ISP_LARB4_SMI_CKPDN, name);
           break;
