...
#define EMI_TSCT4 	(EMI_BASE+0x05B8)
#define EMI_WSCT4 	(EMI_BASE+0x05C0)
#define EMI_BSCT4 	(EMI_BASE+0x05C8)
#define EMI_TSCT5 	(EMI_BASE+0x05D0)
#define EMI_WSCT5 	(EMI_BASE+0x05D8)
#define EMI_BSCT5 	(EMI_BASE+0x05E0)
...
#define EMI_LMEN 	(EMI_BASE+0x0880)
#define EMI_WTCT 	(EMI_BASE+0x0888)
#define EMI_WLCT 	(EMI_BASE+0x0890)
#define EMI_RTCT 	(EMI_BASE+0x0898)
#define EMI_RLCT 	(EMI_BASE+0x08A0)
...
#define Lat_OVERRUN 		(0x00000008)
#define Lat_MON_EN 		(0x00000001)
...
extern void LM_Enable(const unsigned int enable);
extern unsigned int LM_IsOverrun(void);
extern int LM_SetMaster(const unsigned int master);
extern int LM_GetWTransCount(void);
extern int LM_GetWLatCount(void);
extern int LM_GetRTransCount(void);
extern int LM_GetRLatCount(void);
