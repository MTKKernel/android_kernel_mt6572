...
static struct chip_smi smi_map[] = {
	...
	{ 3, NULL, SMI_LARB3_DESC_COUNT }, //larb3
	{ 4, NULL, SMI_LARB4_DESC_COUNT }, //larb4
	{ 5, larb5_desc, SMI_LARB5_DESC_COUNT }, //larb5
	{ 6, common_desc, SMI_COMMON_DESC_COUNT } //common
};
...
static void met_smi_polling(unsigned long long stamp, int cpu)
{
	...
	unsigned int smi_value[150];  //TODO: need re-check
	static int times=0;
