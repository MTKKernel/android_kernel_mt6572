...
static void cci400(unsigned long long stamp, int cpu)
{
	...
	case 1: trace_printk(CCI_FMT1, CCI_VAL1); break;
#endif
	case 2: trace_printk(CCI_FMT2, CCI_VAL2); break;
	case 3: trace_printk(CCI_FMT3, CCI_VAL3); break;
	case 4: trace_printk(CCI_FMT4, CCI_VAL4); break;
#ifdef PROBE_CCI400_CYCLES
	case 5: trace_printk(CCI_FMT5, CCI_VAL5); break;
#endif
	}
}
