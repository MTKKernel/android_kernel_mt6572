...
#define MET_SMI_LARB3_BASE 	0xF5001000 // TODO: need re-check
#define MET_SMI_LARB4_BASE 	0xF5001000 // TODO: need re-check
#define MET_SMI_LARB5_BASE 	0xF7002000

#define MET_SMI_COM_BASE 	0xF4011000

#define SMI_LARB_NUMBER 6
...
int SMI_GetType(int larbno);
int SMI_GetCon(int larbno);
// cnt
...
//common config
int SMI_Comm_GetEna(int commonno);
int SMI_Comm_GetClr(int commonno);
int SMI_Comm_GetType(int commonno);
int SMI_Comm_GetCon(int commonno);
//cnt
