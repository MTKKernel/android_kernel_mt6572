...
struct smi_desc larb0_desc[] = {
	...
	{ 1,	"DISP_RDMA1",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 2,	"DISP_RDMA",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 3,	"DISP_WDMA",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 4,	"MM_CMDQ",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 5,	"MDP_RDMA",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 6,	"MDP_WDMA",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 7,	"MDP_ROTO",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 8,	"MDP_ROTCO",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 9,	"MDP_ROTVO",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC }
};
struct smi_desc larb1_desc[] = {
	...
	{ 6,	"HW_VDEC_PP_INT",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC }
};
struct smi_desc larb2_desc[] = {
	...
	{ 6,	"CAM_LCEI",		SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 7,	"CAM_LCSO",		SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 8,	"JPGENC_RDMA",		SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 9,	"JPGENC_BSDMA",		SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 10,	"VENC_SV_COMV",		SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 11,	"VEND_RD_COMV",		SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 12,	"VENC_RCPU",		SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 13,	"VENC_REC_FRM",		SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 14,	"VENC_REF_LUMA",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 15,	"VENC_REF_CHROMA",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 16,	"VENC_BSDMA",		SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 17,	"VENC_CUR_LUMA",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 18,	"VENC_CUR_CHROMA",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC }
};
struct smi_desc larb5_desc[] = {
	{ 0,	"MJC_MV_RD",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 1,	"MJC_MV_WR",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 2,	"MJC_DMA_RD",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
	{ 3,	"MJC_DMA_WR",	SMI_DEST_ALL, SMI_RW_ALL, SMI_BUS_GMC },
};
struct smi_desc common_desc[] = {
	...
	{ 4,	"AXI_G3D0",	SMI_DEST_EMI, SMI_RW_RESPECTIVE, SMI_BUS_NONE },
	{ 5,	"AXI_G3D1",	SMI_DEST_EMI, SMI_RW_RESPECTIVE, SMI_BUS_NONE },
	{ 6,	"AXI_LARB5",	SMI_DEST_EMI, SMI_RW_RESPECTIVE, SMI_BUS_NONE },
};
...
#define SMI_LARB3_DESC_COUNT 0
#define SMI_LARB4_DESC_COUNT 0
#define SMI_LARB5_DESC_COUNT (sizeof(larb5_desc) / sizeof(struct smi_desc))
