...
//mt6572
extern unsigned int MET_BM_GetBusBusyAllCount(void);
extern unsigned int MET_BM_GetBusBusyCount(const unsigned int counter_num);
extern unsigned int MET_BM_GetEMIClockCount(void);
