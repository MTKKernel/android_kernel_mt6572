...
static void emi_init(void)
{
	...
	BM_SetMonitorCounter(3, BM_MASTER_MD_ARM9 | BM_MASTER_MD_MCU | BM_MASTER_2G_3G_MDDMA, BM_TRANS_TYPE_4BEAT | BM_TRANS_TYPE_8Byte | BM_TRANS_TYPE_BURST_WRAP);
...
static unsigned int emi_polling(unsigned int *emi_value)
{
	...
	lactp = emi_value + 5;
	lactp[0] = BM_GetLatencyCycle(1);
	lactp[1] = BM_GetLatencyCycle(3);
	lactp[2] = BM_GetLatencyCycle(4);
	lactp[3] = BM_GetLatencyCycle(5);
	lactp[4] = BM_GetLatencyCycle(6);
	lactp[5] = BM_GetLatencyCycle(7);

	lactp[6] = BM_GetLatencyCycle(9);
	lactp[7] = BM_GetLatencyCycle(11);
	lactp[8] = BM_GetLatencyCycle(12);
	lactp[9] = BM_GetLatencyCycle(13);
	lactp[10] = BM_GetLatencyCycle(14);
	lactp[11] = BM_GetLatencyCycle(15);
