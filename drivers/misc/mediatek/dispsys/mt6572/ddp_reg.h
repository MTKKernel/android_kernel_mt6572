...
#if 1  /*                                                             */
#define DISPSYS_BLS_GAMMA_SETTING                       DISPSYS_BLS_BASE+0x30
#define DISPSYS_BLS_GAMMA_BOUNDARY                  DISPSYS_BLS_BASE+0x34
#define DISPSYS_BLS_LUT_UPDATE                               DISPSYS_BLS_BASE+0x38
#define DISPSYS_BLS_GAMMA_LUT                               DISPSYS_BLS_BASE+0x400
#endif  /*                                                             */
