...
static int KXTIK1004_WriteCalibration(struct i2c_client *client, int dat[KXTIK1004_AXES_NUM])
{
	...
	if((err = kxt_i2c_write_block(obj->client, KXTIK1004_REG_OFSX, obj->offset, KXTIK1004_AXES_NUM)))
	{
...
//enable selftest bit
	res = kxt_i2c_write_block(client, KXTIK1004_REG_CTL_REG3,  KXTIK1004_SELF_TEST|data, 0x1);
	if(res != KXTIK1004_SUCCESS) //0x2C->BW=100Hz
	{
		return res;
	}
