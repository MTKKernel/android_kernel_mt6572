...
#else
static struct i2c_board_info __initdata bma255_i2c_info ={ I2C_BOARD_INFO(BMA255_DEV_NAME, 0x00)};
#endif 
...
#if 1
	unsigned int bma255_i2c_addr=0;

	if(system_rev<1) // EVB 
	{
		bma255_i2c_addr = BMA255_I2C_ADDR_EVB;		
	}
	else if(system_rev==1)
	{
		bma255_i2c_addr = BMA255_I2C_ADDR_REV_A;				
	}
	else
		bma255_i2c_addr = BMA255_I2C_ADDR_REV_A;		
