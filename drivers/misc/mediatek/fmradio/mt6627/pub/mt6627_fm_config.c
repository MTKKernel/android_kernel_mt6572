...
//                                                                                       
fm_cust_cfg *mt6627_fm_config_check;
export_symbol(mt6627_fm_config_check);
//                          

/* sbp_interface */
extern unsigned char g_lge_mcc[];
extern unsigned char g_lge_mnc[];
extern unsigned char g_lge_subset[];

unsigned char india_mcc_1[4] = "FFF";
unsigned char india_mcc_2[4] = "404";
unsigned char india_mcc_3[4] = "405";

unsigned char india_mnc_1[4] = "FFF";

unsigned char india_subset_1[4] = "FF";
unsigned char india_subset_2[4] = "58";
/* sbp_interface */
...
int MT6627fm_check_INDIA (void)
{
	...
	#if 0
	printk ("jjm_debug : MT6627fm_check_INDIA : g_lge_mcc = %s, g_lge_mnc = %s, g_lge_subset = %s, india_mcc_1 = %s, india_mcc_2 = %s, india_mcc_3 = %s\n",
		g_lge_mcc, g_lge_mnc, g_lge_subset, india_mcc_1, india_mcc_2, india_mcc_3);

	printk ("jjm_debug : MT6627fm_check_INDIA : india_mnc_1 = %s, india_subset_1 = %s, india_subset_2 = %s\n",
		india_mnc_1, india_subset_1, india_subset_2);
	#endif

	/* MCC is 404 */
	result1 = strncmp (g_lge_mcc, india_mcc_2, 3);

	/* MCC is 405 */
	result2 = strncmp (g_lge_mcc, india_mcc_3, 3);

	/* MCC : FFF, MNC : FFF, SUBSET : 58 */
	result3 = strncmp (g_lge_mcc, india_mcc_1, 3);
	result4 = strncmp (g_lge_mnc, india_mnc_1, 3);
	result5 = strncmp (g_lge_subset, india_subset_2, 2);

	#if 0
	printk ("jjm_debug : MT6627fm_check_INDIA : result1 = %d, result2 = %d, result3 = %d, result4 = %d, result5 = %d\n",
		result1, result2, result3, result4, result5);
	#endif

	if (((result1 == 0) || (result2 == 0)) || ((result3 == 0) && (result4 == 0) && (result5 == 0)))
	{
		//printk ("jjm_debug : FM Radio result = 1\n");
		result = 1;
	}
	else
	{
		//printk ("jjm_debug : FM Radio result = 0\n");
		result = 0;
	}
...
//                                                                                      
#define MT6627_FM_CUST_CFG_PATH_S2 "etc/fmr/mt6627_fm_cust_s2.cfg"
#define MT6627_FM_CUST_CFG_PATH_S2_INDIA "etc/fmr/mt6627_fm_cust_s2_india.cfg"
#define MT6627_FM_CUST_CFG_PATH_S4 "etc/fmr/mt6627_fm_cust_s4.cfg"
#define MT6627_FM_CUST_CFG_PATH_S4_INDIA "etc/fmr/mt6627_fm_cust_s4_india.cfg"
#define MT6627_FM_CUST_CFG_PATH_S5 "etc/fmr/mt6627_fm_cust_s5.cfg"
#define MT6627_FM_CUST_CFG_PATH_S5_INDIA "etc/fmr/mt6627_fm_cust_s5_india.cfg"
//                          
fm_s32 MT6627fm_cust_config_setup(const fm_s8 *filepath)
{
    ...
    if (!filepath) {
        //                                                                                       
        #if defined (TARGET_S4) /* jjm_fm_config */
        result = MT6627fm_check_INDIA();
		
        printk ("jjm_debug : MT6627fm_cust_config_setup : result = %d\n", result);

        if (result == 1)
        {
            //printk ("jjm_debug : MT6627fm_cust_config_setup : INDIA!!!\n");
            filep = MT6627_FM_CUST_CFG_PATH_S4_INDIA;
            WCN_DBG(FM_NTC | MAIN, "MT6627_FM_CUST_CFG_PATH_S4_INDIA"); 
        }
        else
        {
            //printk ("jjm_debug : MT6627fm_cust_config_setup : not INDIA!!!\n");
            filep = MT6627_FM_CUST_CFG_PATH_S4;
            WCN_DBG(FM_NTC | MAIN, "MT6627_FM_CUST_CFG_PATH_S4"); 
        }
        #elif defined(TARGET_S2)
        result = MT6627fm_check_INDIA();
        ...
        {
            //printk ("jjm_debug : MT6627fm_cust_config_setup : INDIA!!!\n");
            filep = MT6627_FM_CUST_CFG_PATH_S2_INDIA;
            WCN_DBG(FM_NTC | MAIN, "MT6627_FM_CUST_CFG_PATH_S2_INDIA"); 
        }
        else
        {
            //printk ("jjm_debug : MT6627fm_cust_config_setup : not INDIA!!!\n");
            filep = MT6627_FM_CUST_CFG_PATH_S2;
            WCN_DBG(FM_NTC | MAIN, "MT6627_FM_CUST_CFG_PATH_S2"); 
        }  
		#elif defined(TARGET_S5)
		result = MT6627fm_check_INDIA();
        ...
        {
            //printk ("jjm_debug : MT6627fm_cust_config_setup : INDIA!!!\n");
            filep = MT6627_FM_CUST_CFG_PATH_S5_INDIA;
            WCN_DBG(FM_NTC | MAIN, "MT6627_FM_CUST_CFG_PATH_S5_INDIA"); 
        }
        else
        {
            //printk ("jjm_debug : MT6627fm_cust_config_setup : not INDIA!!!\n");
            filep = MT6627_FM_CUST_CFG_PATH_S5;
            WCN_DBG(FM_NTC | MAIN, "MT6627_FM_CUST_CFG_PATH_S5"); 
        }
        #else
