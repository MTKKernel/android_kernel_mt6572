...
extern int fc8150_bypass_read(HANDLE hDevice, u8 chip, u8 addr, u8 *data, u16 length);
extern int fc8150_bypass_write(HANDLE hDevice, u8 chip, u8 addr, u8 *data, u16 length);
...
int fci_bypass_write(HANDLE hDevice, u8 chip, u8 addr, u8 alen, u8* data, u8 len)
{
    int res;
