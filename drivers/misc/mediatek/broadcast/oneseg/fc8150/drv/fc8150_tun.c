...
static int fc8150_set_filter(HANDLE hDevice)
{
    ...
    else if (bbm_xtal_freq == 26000)
    {
        ...
        fc8150_write(hDevice, 0x3B, 0x00);
    PRINTF(hDevice, "fc8150_set_filter xtal : %d \n", bbm_xtal_freq);
    }
    ...
    for(i=0; i<10; i++) {
        ...
        PRINTF(hDevice, "fc8150_set_filter xtal : %d, cal : 0x%x, i : %d\n", bbm_xtal_freq, cal_mon, i);
...
int fc8150_tuner_init(HANDLE hDevice, u32 band)
{
    ...
    fc8150_write(hDevice, 0x02, 0x81);
    PRINTF(hDevice, "fc8150_tuner_init xtal : %d \n", bbm_xtal_freq);
