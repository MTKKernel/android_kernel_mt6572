...
int BBM_TS_CALLBACK_REGISTER(u32 userdata, int (*callback)(u32 userdata, u8 *data, int length))
{
...
int BBM_AC_CALLBACK_REGISTER(u32 userData, int (*callback)(u32 userdata, u8* data, int length))
{
