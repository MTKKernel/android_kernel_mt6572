...
#define MSENSOR_IOCTL_READ_SENSORDATA_AT	_IOR(MSENSOR, 0x53, int)
...
#define ALPSIO_AD_GET_DELAY _IOR(MSENSOR, 0x33, int) 
#define ALPSIO_AD_GET_DATA _IOR(MSENSOR, 0x34, int [11]) 
#define ALPSIO_AD_SET_DATA _IOW(MSENSOR, 0x35, int [15]) 
