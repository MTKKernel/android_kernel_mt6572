...
# LGE DOME_KEY_FEATURE START 
ifdef LGE_USE_DOME_KEY
KBUILD_CFLAGS += -DLGE_USE_DOME_KEY
endif 
# LGE DOME_KEY FEATURE END 
...
ifeq ($(CONFIG_ARCH_MTK_PROJECT),"muse72_s4_kk")
KBUILD_CFLAGS += -DTARGET_S4
endif

ifeq ($(CONFIG_ARCH_MTK_PROJECT),"muse72_s2_kk0")
KBUILD_CFLAGS += -DTARGET_S2
endif

ifeq ($(CONFIG_ARCH_MTK_PROJECT),"muse72_s5_kk")
KBUILD_CFLAGS += -DTARGET_S5
endif
